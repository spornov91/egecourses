...
public class AdapterSubjects extends ArrayAdapter<String>
	{  
	...
	public AdapterSubjects (Context context, String[][] obj) { //Drawable[] imgid 
			super(context, R.layout.adapter_subjects, obj);  
			...
			View rowView=inflater.inflate(R.layout.adapter_subjects, null,true);  
